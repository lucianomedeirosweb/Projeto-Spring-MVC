...
<script>
	function confirmacao(id, descricao) {
		...
		if (resposta == true) {
			window.location.href = "<c:url value='/vendas/" + id + "/removeItem' />";
		}
	}
</script>
<div class="container-fluid">
	<div class="row">
		...
		<div class="col-sm-9 col-sm-offset-3 col-md-10 col-md-offset-2 main">
			<h1 class="page-header text-center">Cadastro de Venda</h1>

			<div class="container-fluid">
				<c:url var="addItem" value="/vendas/addItem" />
				<c:url var="cadastro" value="/vendas/cadastro" />				
					...
					<div class="form-group">
						...
						<div class="col-sm-3" style="margin-left: -17px;">
							...
							<form:select path="pessoa.id" class="form-control">
								<form:option value="" label="-- Clientes --" />
								<form:options items="${selectClientes}" />
							</form:select>
						</div>
						...
						<button type="submit" class="btn btn-primary"
							style="margin-right: 10px; margin-top: 25px;">Finalizar Venda</button>						
					</div>
				</form:form>
			</div>
